...
export default function AdminLayout({
  ...
  if (checking) {
    return (
      <div className="min-h-screen bg-background flex flex-col justify-center items-center gap-4">
        ...
        <span className="text-label-md font-bold text-on-surface-variant animate-pulse">
  ...
  // 4. Render main merchant console for verified administrators
  return (
    <div className="min-h-screen bg-background text-on-surface font-body-md antialiased transition-all duration-300">
